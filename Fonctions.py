...
def images(font):
    ...
    bank['current_life'] = font.render("Vie :", 1,  (255, 0, 0))

    font_lose = pygame.font.Font('./Text/Positive System.otf', 60)
    bank["lose"] = font_lose.render('Game Over ...', True, (255, 255, 255))
...
def New_Enemy(img, enemys, largeur, hauteur, fenetre, i):
    ...
    """
    enemys.append(Enemy(randint(200, largeur - 50),
                        randint(-hauteur // 2, 0), img, fenetre, 15, 2, 20, largeur, "Enemy", choice([True, False])))
    enemys[-1].Choix(i)
...
def New_Bonus(tabBonus, bank, fenetre, largeur, time):
    ...
    tabBonus.append(Bonus(randint(150, largeur),
                          randint(-20, -5), bank[t], fenetre, t, time))
